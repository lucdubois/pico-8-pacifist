...
function _draw()
    ...
    -- drawTriangle()
    spr_r( player.sprite, player.x-4, player.y-4, player.angle, 1, 1) -- draw the sprite using the values of our player object 
    for enemy in all(enemies) do
...

